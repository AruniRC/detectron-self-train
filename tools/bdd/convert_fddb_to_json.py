...
# Cityscapes video car HP
cityscapes_car_HP_conf050_fddb = '/mnt/nfs/scratch1/pchakrabarty/cityscapes/tracklet_len5'
cityscapes_car_HP_conf050_json = 'cityscapes_cars_HPlen5.json'

# Select fddb and json files
fddb_file = cityscapes_car_HP_conf050_fddb #bdd_peds_dets_20k_conf050_fddb
json_file = cityscapes_car_HP_conf050_json #'tmp/conf080_det.json' #bdd_peds_dets_conf080_json
