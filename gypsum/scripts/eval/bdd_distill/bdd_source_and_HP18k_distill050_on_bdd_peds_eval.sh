...
python tools/test_net.py \
    ...
    --output_dir results/bdd_source_and_HP18k_distill050/bdd_peds_val \
    --load_ckpt Outputs/bdd_distill050/bdd_source_and_HP18k_distill050/ckpt/model_step14999.pth \
