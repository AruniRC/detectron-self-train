...
python tools/test_net.py \
    ...
    --output_dir results/bdd_source_and_dets18k_distill070/bdd_peds_val \
    --load_ckpt Outputs/bdd_distill070/bdd_source_and_dets18k_distill070/ckpt/model_step9999.pth \
