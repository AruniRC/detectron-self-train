...
python tools/test_net.py \
    ...
    --output_dir results/bdd_peds_and_dets20k_90k_iters_reset_opt70k/bdd_peds_not_clear_any_daytime_val \
    --load_ckpt Outputs/bdd_peds_dets_joint/bdd_peds_and_dets20k_reset_opt70k/ckpt/model_step19999.pth \
