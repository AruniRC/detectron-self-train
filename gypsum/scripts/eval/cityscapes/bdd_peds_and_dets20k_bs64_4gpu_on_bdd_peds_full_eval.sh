...
python tools/test_net.py \
    ...
    --output_dir results/bdd_peds_and_dets20k_bs64_4gpu/bdd_peds_full_val \
    --load_ckpt Outputs/bdd_peds_dets_bs64_4gpu/bdd_peds_and_dets20k_bs64_4gpu/ckpt/model_step24999.pth \
