#!/usr/bin/env bash
#SBATCH --job-name=eval_bdd_HP_only_on_bdd_peds_val
...
# --load_ckpt Outputs/cityscapes/bdd_hp_only/ckpt/model_step34999.pth \
python tools/test_net.py \
    --dataset bdd_peds_val \
    --cfg configs/baselines/cityscapes.yaml \
    --output_dir results/bdd_hp18k_only/bdd_peds_val \
    --load_ckpt Outputs/cityscapes/bdd_hp18k_only/ckpt/model_step64999.pth \
