...
python tools/test_net.py \
    ...
    --output_dir results/bdd_peds_and_dets20k_140k_iters_reset_opt_70k/bdd_peds_val \
    --load_ckpt Outputs/bdd_peds_dets_joint/bdd_peds_and_dets20k_reset_opt70k/ckpt/model_step34999.pth \
