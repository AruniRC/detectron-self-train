...
python tools/test_net.py \
    ...
    --output_dir results/bdd_source_and_hp18k/bdd_peds_not_clear_any_daytime_val \
    --load_ckpt Outputs/bdd_peds_dets_bs64_4gpu/bdd_peds_and_hp18k/ckpt/model_step14999.pth \
