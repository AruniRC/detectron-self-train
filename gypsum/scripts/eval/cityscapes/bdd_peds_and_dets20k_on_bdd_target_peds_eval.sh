...
python tools/test_net.py \
    ...
    --output_dir results/bdd_peds_and_dets20k/bdd_peds_not_clear_any_daytime_val \
    --load_ckpt Outputs/bdd_peds_dets_joint/bdd_peds_and_dets20k/ckpt/model_step34999.pth \
