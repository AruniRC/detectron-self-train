#!/usr/bin/env bash
#SBATCH --job-name=eval_bdd_data_dist_mid
#SBATCH -o gypsum/logs/%j_eval_bdd_data_dist_mid.txt 
#SBATCH -e gypsum/errs/%j_eval_bdd_data_dist_mid.txt
...
ROOT=/mnt/nfs/scratch1/pchakrabarty/bdd_recs/rebuttal_results/data_distill/bdd_data_dist_mid
DATASET_NAME=bdd_data_dist_mid

python tools/test_net.py \
    --dataset bdd_peds_dets18k_target_domain \
    --cfg configs/baselines/bdd_data_dist_mid.yaml \
