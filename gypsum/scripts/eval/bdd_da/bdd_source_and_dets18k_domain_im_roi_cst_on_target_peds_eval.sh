...
python tools/test_net.py \
    ...
    --output_dir results/bdd_source_and_dets18k_domain_im_roi_cst/bdd_peds_not_clear_any_daytime_val \
    --load_ckpt Outputs/bdd_domain_im_roi_cst/bdd_source_and_dets18k_domain_im_roi_cst/ckpt/model_step24999.pth \
    --set TRAIN.JOINT_TRAINING False TRAIN.GT_SCORES False TEST.SCORE_THRESH 0.1 \
    --multi-gpu-testing
