...
python tools/test_net.py \
    ...
    --output_dir results/bdd_source_and_dets18k_domain_im/bdd_peds_not_clear_any_daytime_val \
    --load_ckpt Outputs/bdd_domain_im/bdd_source_and_dets18k_domain_im/ckpt/model_step14999.pth \
