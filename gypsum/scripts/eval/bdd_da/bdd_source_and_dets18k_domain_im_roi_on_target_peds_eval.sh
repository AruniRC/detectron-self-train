...
python tools/test_net.py \
    ...
    --output_dir results/bdd_source_and_dets18k_domain_im_roi/bdd_peds_not_clear_any_daytime_val \
    --load_ckpt Outputs/bdd_domain_im_roi/bdd_source_and_dets18k_domain_im_roi/ckpt/model_step24999.pth \
