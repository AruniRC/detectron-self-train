...
TRAIN_IMDB=CS6-train-HP+WIDER-da-roi_5k
CFG_PATH=configs/cs6/e2e_faster_rcnn_R-50-C4_1x_domain_roi.yaml
WT_PATH=Outputs/e2e_faster_rcnn_R-50-C4_1x_domain_roi/Oct07-20-07-19_node116_step/ckpt/model_step4999.pth
