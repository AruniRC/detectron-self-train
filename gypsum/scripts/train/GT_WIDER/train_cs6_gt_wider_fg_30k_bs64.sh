#!/usr/bin/env bash
#SBATCH --job-name=cs6-GT-WIDER
#SBATCH -o gypsum/logs/%j_train_cs6-GT-WIDER.txt 
#SBATCH -e gypsum/errs/%j_train_cs6-GT-WIDER.txt
...
python tools/train_net_step.py \
    ...
    --cfg configs/cs6/e2e_faster_rcnn_R-50-C4_1x_8gpu_joint-fg_bs64_30k.yaml  \
