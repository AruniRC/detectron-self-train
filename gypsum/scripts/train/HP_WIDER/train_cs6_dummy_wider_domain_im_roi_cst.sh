#!/usr/bin/env bash
#SBATCH --job-name=da-im-roi-cst_cs6-dummy-WIDER
#SBATCH -o gypsum/logs/%j_cs6-dummy-WIDER.txt 
#SBATCH -e gypsum/errs/%j_cs6-dummy-WIDER.txt
...
python tools/train_net_step.py \
    --dataset cs6-train-dummy+WIDER \
    --cfg configs/cs6/e2e_faster_rcnn_R-50-C4_1x_domain_im_roi_cst.yaml  \
