#!/usr/bin/env bash
#SBATCH --job-name=cs6-Det-WIDER-bs64-4gpu
#SBATCH -o gypsum/logs/%j_cs6-Dets-WIDER-bs64-4gpu.txt 
#SBATCH -e gypsum/errs/%j_cs6-Dets-WIDER-bs64-4gpu.txt
...
python tools/train_net_step.py \
    --dataset cs6-train-det+WIDER \
    --cfg configs/cs6/e2e_faster_rcnn_R-50-C4_1x_4gpu_joint_bs64_30k.yaml  \
