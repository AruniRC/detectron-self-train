#!/usr/bin/env bash
#SBATCH --job-name=bdd_source_and_dets18k_distill050.sh
#SBATCH -o gypsum/logs/%j_bdd_source_and_dets18k_distill050.sh.txt 
#SBATCH -e gypsum/errs/%j_bdd_source_and_dets18k_distill050.sh.txt
