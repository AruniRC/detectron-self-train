#!/usr/bin/env bash
#SBATCH --job-name=bdd_source_and_HP18k_night_domain_im_roi_cst
#SBATCH -o gypsum/logs/%j_bdd_source_and_HP18k_night_domain_im_roi_cst.txt 
#SBATCH -e gypsum/errs/%j_bdd_source_and_HP18k_night_domain_im_roi_cst.txt
