#!/usr/bin/env bash
#SBATCH --job-name=bdd_source_and_HP18k_distill030
#SBATCH -o gypsum/logs/%j_bdd_source_and_HP18k_distill030.txt 
#SBATCH -e gypsum/errs/%j_bdd_source_and_HP18k_distill030.txt
