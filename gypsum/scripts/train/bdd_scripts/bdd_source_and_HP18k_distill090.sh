#!/usr/bin/env bash
#SBATCH --job-name=bdd_source_and_HP18k_distill090
#SBATCH -o gypsum/logs/%j_bdd_source_and_HP18k_distill090.txt 
#SBATCH -e gypsum/errs/%j_bdd_source_and_HP18k_distill090.txt
