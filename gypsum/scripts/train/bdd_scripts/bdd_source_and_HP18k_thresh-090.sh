#!/usr/bin/env bash
#SBATCH --job-name=bdd_source_and_HP18k_thresh-090
#SBATCH -o gypsum/logs/%j_bdd_source_and_HP18k_thresh-090.txt 
#SBATCH -e gypsum/errs/%j_bdd_source_and_HP18k_thresh-090.txt
...
python tools/train_net_step.py \
    --dataset bdd_peds+HP18k_thresh-090 \
