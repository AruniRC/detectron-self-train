#!/usr/bin/env bash
#SBATCH --job-name=bdd_source_and_HP18k_domain_im_roi
#SBATCH -o gypsum/logs/%j_bdd_source_and_HP18k_domain_im_roi.txt 
#SBATCH -e gypsum/errs/%j_bdd_source_and_HP18k_domain_im_roi.txt
