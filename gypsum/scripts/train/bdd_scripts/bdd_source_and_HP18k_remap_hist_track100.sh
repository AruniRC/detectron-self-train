#!/usr/bin/env bash
#SBATCH --job-name=bdd_source_and_HP18k_remap_hist_track100
#SBATCH -o gypsum/logs/%j_bdd_source_and_HP18k_remap_hist_track100.txt 
#SBATCH -e gypsum/errs/%j_bdd_source_and_HP18k_remap_hist_track100.txt
...
python tools/train_net_step.py \
    --dataset bdd_peds+HP18k_remap_hist \
