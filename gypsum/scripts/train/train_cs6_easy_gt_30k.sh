#!/usr/bin/env bash
#SBATCH --job-name=cs6-easy-GT
#SBATCH -o gypsum/logs/%j_train_cs6-easy-GT.txt 
#SBATCH -e gypsum/errs/%j_train_cs6-easy-GT.txt
...
python tools/train_net_step.py \
    --dataset cs6-train-easy-gt-sub \
    --cfg configs/cs6/e2e_faster_rcnn_R-50-C4_1x_8gpu_30k.yaml  \
