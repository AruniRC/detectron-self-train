#!/usr/bin/env bash
#SBATCH --job-name=bdd_peds_source_and_dets
#SBATCH -o gypsum/logs/%j_bdd_peds_source_and_dets.txt 
#SBATCH -e gypsum/errs/%j_bdd_peds_source_and_dets.txt
...
python tools/train_net_step.py \
    --dataset bdd_peds+DETS_20k \
    --cfg configs/baselines/bdd_peds_dets_joint140k_drop_at_100k.yaml  \
    --iter_size 2 \
    --use_tfboard
