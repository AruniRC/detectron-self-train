#!/usr/bin/env bash
#SBATCH --job-name=cs6-easy-GT-fg-WIDER
#SBATCH -o gypsum/logs/%j_cs6-easy-GT-fg-WIDER.txt 
#SBATCH -e gypsum/errs/%j_cs6-easy-GT-fg-WIDER.txt
...
python tools/train_net_step.py \
    ...
    --cfg configs/cs6/e2e_faster_rcnn_R-50-C4_1x_8gpu_joint-fg_30k.yaml  \
