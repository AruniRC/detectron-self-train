#!/usr/bin/env bash
#SBATCH --job-name=bdd_source_and_labeled_001
#SBATCH -o gypsum/logs/%j_bdd_source_and_labeled_001.txt 
#SBATCH -e gypsum/errs/%j_bdd_source_and_labeled_001.txt
