#!/usr/bin/env bash
#SBATCH --job-name=bdd_source_and_labeled_100
#SBATCH -o gypsum/logs/%j_bdd_source_and_labeled_100.txt 
#SBATCH -e gypsum/errs/%j_bdd_source_and_labeled_100.txt
