#!/usr/bin/env bash
#SBATCH --job-name=Dtrain_cs6-GT-noisy
#SBATCH -o gypsum/logs/%j_train_cs6-GT-noisy.txt 
#SBATCH -e gypsum/errs/%j_train_cs6-GT-noisy.txt
...
# trial run: just using CS6 data with noisy levels


python tools/train_net_step.py \
    --dataset cs6-train-gt-noisy-0.5 \
